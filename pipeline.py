...
# Test etme
prompt = ("""Sen yalnızca Galatasaray hakkında bilgi veren bir modelsin. Eğer sorulan soru Galatasaray ile ilgili değilse,"Bu konunda yanıt veremem." diye cevap ver.
Soru: Rüyada yılan görmek ?""")

prompt2=("Galatasaray lisesi \n ")
